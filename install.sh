...
echo ""
echo "Note: The Zsh prompt uses standard Unicode emoji (e.g. macOS, Docker, Linux)."
echo "      Most terminals render them out of the box; no special font required."
echo "      A Nerd Font is still recommended for other UI (eza --icons, etc.)."
